                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="#" className="space-y-2 md:space-y-2">
                        <div>
                            ...
                            <input type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="MD. " required=""/>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea type="text" name="bio" id="bio" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Tell something about your self" required=""/>
                        </div>

                        <div>
                            <label htmlFor="avater" className="block mb-2 text-sm font-medium text-gray-900">Avater</label>
                            <input type="text" name="avater" id="avater" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Avatar link" required=""/>
                        </div>

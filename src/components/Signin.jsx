            ...
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="#" className="space-y-4 md:space-y-6">
                        ...
                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">Don't have an account yeat? <button onClick={() => props.onFormSwitch('signup')} className="font-medium text-primary-600 hover:underline">Sign up</button></p>
                    </form>
                </div>
            </div>
        </div>
